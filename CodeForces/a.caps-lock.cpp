...
const int    MxsZ = (int)1e4 + 100, mod = 1073741824,         oo = 0x3f3f3f3f;
...
int main()
{
    ...
    cin >> s;
    rep(i, 1, sz(s)) if(s[i] >= 97) RT(s);
    if(s[0] >= 97)   cout << char(s[0] - 32); else cout << char(s[0] + 32);
    rep(i, 1, sz(s)) cout << char(s[i] + 32);
}
