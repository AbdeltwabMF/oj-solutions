...
ll n, a, ans;
string s;
map <string, ll> ma = { {"A", oo}, {"B", oo}, {"C", oo}, {"AB", oo}, {"AC", oo}, {"BC", oo}, {"ABC", oo} };
...
int main()
{
    ...
    ans = min({ma["ABC"], ma["A"] + ma["B"] + ma["C"], ma["AB"] + ma["C"],
               ma["AC"] + ma["B"], ma["BC"] + ma["A"], ma["AB"] + ma["AC"],
                ma["AB"] + ma["BC"], ma["AC"] + ma["BC"]});
